"""Insight generator — minimal prompt + precomputed signals.

60 tokens total prompt. Precomputes topics/tone/phrases at zero cost,
sends only the minimum to LLM for personalized reframing.
"""
